...
export const RoadmapViewTopBar = ()=> {
  return(
    <Box height={'100px'} bgcolor={'success.main'} pt={1} className={RoadmapViewStyles.topBarContainer}>
      <Link href="/">
        <GoBackBtnDark startIcon={<CaretLeft size={16}/>}>Go Back</GoBackBtnDark>
      </Link>
      <Typography variant="h1" color="white" pl={5} mt={-1}>Roadmap</Typography>
